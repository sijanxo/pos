...
export default function SalesLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="sales-layout min-h-screen bg-background">
      {/* Top Navigation */}
          ...
          <div className="nav-left flex items-center gap-6">
            ...
            <div className="nav-links flex items-center gap-1">
              ...
              {useCanAccess('inventory') && (
                <NavLink href="/sales/inventory" icon={<Package size={16} />}>
                  Inventory
                </NavLink>
              )}
              
              {useCanAccess('reports') && (
                <NavLink href="/sales/reports" icon={<BarChart3 size={16} />}>
                  Reports
                </NavLink>
              )}
              
              {useCanAccess('settings') && (
                <NavLink href="/sales/settings" icon={<Settings size={16} />}>
                  Settings
                </NavLink>
              )}
            </div>
