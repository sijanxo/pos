    ...
    <div className="flex flex-col w-full h-screen bg-gray-900 text-gray-100 relative">
      <div className="flex-1 overflow-hidden flex flex-col p-4 pb-[160px]">
        ...
        <div className="flex-1 flex flex-col min-h-0">
          <h2 className="text-lg font-medium mb-2 text-gray-300 flex-shrink-0">Cart Items</h2>
          <div className="flex-1 overflow-y-auto overflow-x-hidden min-h-0">
            {cartItems.length > 0 ? (
              <div className="space-y-2">
                <div className="p-3 bg-gray-700 rounded-lg flex justify-between items-center font-medium text-gray-300 text-sm sticky top-0 z-10">
